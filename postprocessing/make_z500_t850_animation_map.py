...
MAP_DIR = MAPS_DIR / "animation"
MAP_DIR.mkdir(parents=True, exist_ok=True)


T850_FILL_LEVELS = np.arange(-4, 29, 1)
T850_COLORBAR_TICKS = np.arange(-4, 29, 4)

Z500_CONTOUR_LEVELS = np.arange(480, 620, 4)
...
def main():
    ...
    outfile = MAP_DIR / f"z500_t850_animation_{valid_time.replace(':', '-')}.png"
